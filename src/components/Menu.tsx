...
const categories: Category[] = [
  {
    ...
    items: [
      ...
      { name: 'Veg Hot Soup', price: 120, img: pexels(2132942) },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Veg Malai Kofta', price: 250, img: pexels(3609896) },
      { name: 'Palak Paneer', price: 240, img: pexels(5410400) },
      { name: 'Kadai Paneer', price: 240, img: pexels(6260921) },
      { name: 'Paneer Butter Masala', price: 250, img: pexels(2313686) },
      { name: 'Paneer Tikka Masala', price: 240, img: pexels(1624487) },
      { name: 'Paneer Shahi Kurma', price: 250, img: pexels(699953) },
      { name: 'Paneer Burji Masala', price: 250, img: pexels(4449068) },
      { name: 'Veg Mushroom Masala', price: 220, img: pexels(1435904) },
      { name: 'Kadai Mushroom', price: 240, img: pexels(3590401) },
      { name: 'Kaju Kurma', price: 240, img: pexels(1893556) },
      { name: 'Kaju Curry', price: 240, img: pexels(2474658) },
      { name: 'Kaju Paneer', price: 280, img: pexels(1410235) },
      { name: 'Veg Raja Rani', price: 240, img: pexels(2611917) },
    ],
  },
  {
    id: 'breads',
    ...
    items: [
      ...
      { name: 'Paneer Tikka', price: 260, img: pexels(3928854) },
      { name: 'Mushroom Tikka', price: 240, img: pexels(8751408) },
      { name: 'Aloo Tikka', price: 200, img: pexels(12083251) },
    ],
  },
  {
    id: 'egg-curries',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Veg Biryani', price: 210, img: pexels(3735168) },
      { name: 'Paneer Biryani', price: 250, img: pexels(1893557) },
      { name: 'Mushroom Biryani', price: 240, img: pexels(2233353) },
