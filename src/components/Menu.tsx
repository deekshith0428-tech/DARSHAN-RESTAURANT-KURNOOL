...
const categories: Category[] = [
  {
    ...
    items: [
      ...
      { name: 'Veg Hot Soup', price: 120, img: '/images/gallery/Screenshot 2026-07-14 001231.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Veg Malai Kofta', price: 250, img: '/images/gallery/Screenshot 2026-07-14 001516.png' },
      ...
      { name: 'Paneer Butter Masala', price: 250, img: '/images/gallery/Screenshot 2026-07-14 102849.png' },
      { name: 'Paneer Tikka Masala', price: 240, img: '/images/gallery/Screenshot 2026-07-14 102716.png' },
      { name: 'Paneer Shahi Kurma', price: 250, img: '/images/gallery/Screenshot 2026-07-14 103201.png' },
      { name: 'Paneer Burji Masala', price: 250, img: '/images/gallery/Screenshot 2026-07-14 103325.png' },
      { name: 'Veg Mushroom Masala', price: 220, img: '/images/gallery/Screenshot 2026-07-14 103422.png' },
      { name: 'Kadai Mushroom', price: 240, img: '/images/gallery/Screenshot 2026-07-14 103658.png' },
      { name: 'Kaju Kurma', price: 240, img: '/images/gallery/Screenshot 2026-07-14 103825.png' },
      { name: 'Kaju Curry', price: 240, img: '/images/gallery/Screenshot 2026-07-14 104002.png' },
      { name: 'Kaju Paneer', price: 280, img: '/images/gallery/Screenshot 2026-07-14 104106.png' },
      { name: 'Veg Raja Rani', price: 240, img: '/images/gallery/Screenshot 2026-07-14 104208.png' },
    ],
  },
  {
    id: 'breads',
    ...
    items: [
      ...
      { name: 'Paneer Tikka', price: 260, img: '/images/gallery/Screenshot 2026-07-14 101659.png' },
      { name: 'Mushroom Tikka', price: 240, img: pexels(8751408) },
      { name: 'Aloo Tikka', price: 200, img: '/images/gallery/Screenshot 2026-07-14 101911.png' },
    ],
  },
  {
    id: 'egg-curries',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Veg Biryani', price: 210, img: '/images/gallery/Screenshot 2026-07-14 102235.png' },
      { name: 'Paneer Biryani', price: 250, img: '/images/gallery/Screenshot 2026-07-14 102402.png' },
      { name: 'Mushroom Biryani', price: 240, img:'/images/gallery/Screenshot 2026-07-14 102519.png' },
